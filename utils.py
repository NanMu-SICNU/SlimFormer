...
class ImageToImage2D(Dataset):
    """
    Reads the img and applies the augmentation transform on them.
    Usage:
    ...
    def __getitem__(self, idx):
        ...
        # print(os.path.join(self.output_path, image_filename[: -3] + "jpg"))
        # print(os.path.join(self.input_path, image_filename))
        ...
        # print('1', image.shape, mask.shape)
...
class Image2D(Dataset):
    """
    Reads the img and applies the augmentation transform on them. As opposed to ImageToImage2D, this
