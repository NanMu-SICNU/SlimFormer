...
def rotation(root_path, img_name):
    img = Image.open(os.path.join(root_path, img_name))
    rotation_img = img.transpose(Image.ROTATE_90)
    # rotation_img = img.rotate(20, expand=True) #旋转角度
...
import cv2
import numpy as np
imageDir = r'E:\Pycharm\project\COVID19\dataset\findlDataset\labelR'    #要改变的图片的路径文件夹
saveDir = r'E:\Pycharm\project\COVID19\dataset\findlDataset\labelAug'   #要保存的图片的路径文件夹
...
for name in os.listdir(imageDir):
    ...
    # print(os.path.join(imageDir, name), os.path.join(saveDir,saveName))
