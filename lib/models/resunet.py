"""
@Author: Hu yiyue
@Detail: SCI830_Pytorch resunet.py
@Time: 2022-09-29 10:12
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, is_ca=True, reduction=16):
        super().__init__()
        # self.is_se = if_se
        # self.is_ca = is_ca
        ...
        # if self.is_ca:
            # print("**************succeed**************")
        #     self.se = SE(out_channels * self.expansion, reduction)
        #     self.ca = CoorAttention(in_channels=out_channels * self.expansion, out_channels=out_channels * self.expansion)
...
def resnet34(imgchan, numclasses=2, pretrain=False):
    """ return a ResNet 34 object
    """
    model = ResNet(imgchan, numclasses, BasicBlock, [1, 2, 4, 1])
    # if pretrain:
